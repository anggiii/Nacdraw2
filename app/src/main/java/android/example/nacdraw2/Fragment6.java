...
public class Fragment6 extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        VideoView videoView = view.findViewById(R.id.vid_berenang1);

        videoView.setVideoURI(Uri.parse("android.resource://" + getActivity().getPackageName() + "/" + R.raw.vidbasket1));
        videoView.setMediaController(new MediaController(getActivity()));
        videoView.start();

        VideoView videoView2 = view.findViewById(R.id.vid_berenang2);
        ...
        btn1 = view.findViewById(R.id.btnberenang1);
    ...
    public void onClick(View view) {
        String txt = "https://www.youtube.com/watch?v=U4ASYydZrds";
        switch (view.getId()) {
            case R.id.btnberenang1:
